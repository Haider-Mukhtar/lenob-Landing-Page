...
export const expertise = [
  ...
  },
  {
    ...
    tag: "Boost visibility, capture leads, and maximize ROI.",
    description: "With seamless user experiences and data-backed optimizations, Google Ads Management help you maximize the value of every visitor.",
    banner: GoogleAdsBanner,
  },
  {
    id: 3,
    title: "Facebook & Instagram Ads",
    tag: "Connect, engage, and convert effortlessly",
  ...
  },
  {
    id: 4,
    title: "SEO Services",
    tag: "Get found, stay relevant, and grow organically.",
