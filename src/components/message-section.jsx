...
const MessageSection = () => {
  return (
    <div className="w-full">
      <MaxWidthWrapper>
        <div className="py-12 w-full px-32 bg-gradient-to-r from-[#B4E7DD] to-[#91D8F7] rounded-3xl drop-shadow-md">
          <HeadingWithEllipse heading={"A Message to Ambitious Entrepreneurs"} width={"w-3/4"} />
          <div className="text-black text-3xl space-y-7 mt-10 w-4/6">
            ...
            <div className="relative">
              <img src={RedEllipse} className="absolute -top-7 -left-10" alt="red-ellipse-shape" />
